...
function Coins() {
  ...
  // coins state는 coins로 이루어진 array 이라는 것을 명시해줌
  // const [coins, setCoins] = useState<CoinInterface[]>([]);
  // const [loading, setLoading] = useState(true);

  // useEffect 안에서 함수를 만들고 바로 실행하는 방법
  // (() => console.log(1))(); >> 1이 바로 출력된다.
  // setCoins()를 사용해서 coins를 가져온 json 데이터 40000개 중 100개를 잘라서 넣어준다.
  // 로딩 값을 false로 바꾼다.
  // useEffect(() => {
  //   (async () => {
